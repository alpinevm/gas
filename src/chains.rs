...
lazy_static::lazy_static! {
    static ref CHAIN_ID_TO_NAME_MAP: Value = serde_json::from_str(CHAIN_ID_TO_NAME).unwrap();
    static ref CHAIN_ID_TO_RPCS_MAP: Value = serde_json::from_str(CHAIN_ID_TO_RPCS).unwrap();
}
